...
export default function BuildCompDetail({ button, children, highlights }) {
  return (
    <main
      className={`w-full h-fit py-3 px-5 rounded ${
        highlights ? highlights : "bg-neutral-800"
      } delay-300 duration-150 ease-in-out`}
    >
      <Disclosure>
        {({ open }) => (
