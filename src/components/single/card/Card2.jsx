export default function Card2({ background, image, title, children }) {
  return (
    <main
      className={`w-full aspect-video flex items-center p-5 lg:p-10 rounded delay-300 duration-150 ease-in-out ${background} scale-up-center hover:cursor-pointer`}
    >
      <section
      ...
      <section className="flex-1 overflow-hidden text-ellipsis">
        <h1 className={`text-lg lg:text-2xl font-extrabold`}>{children}</h1>
